...
module top (
  ...
  wire [`WORD_SIZE-1:0] data_in_a, data_in_o;
  wire [`WORD_SIZE-1:0] data_out_a, data_out_o;
  wire [`WORD_SIZE_W-1:0]  data_in_b;
  wire [`WORD_SIZE_W-1:0] data_out_b;
