...
module tpu (
    ...
    out_c,
    output reg [      `WORD_SIZE_W-1:0] in_b,
    input      [      `WORD_SIZE_W-1:0] out_b
);
  ...
  wire [`DATA_SIZE_W-1:0] dataout_b_3;
  wire [`DATA_SIZE_W-1:0] dataout_b_4;

  sync_fifo_w fifo_b_1 (
      .clk(clk),
      .rst(sys_rst),
      .data_in(datain_b_1),
      .w_en(!stop_read),
