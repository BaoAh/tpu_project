...
def cifar10_qnn(input_shape, num_classes):
    model = cifar10(input_shape=input_shape, num_classes=num_classes)
    ...
    q_model.compile(loss='sparse_categorical_crossentropy',
                    optimizer='adam',
                    metrics=['accuracy'])
